...
- `torchao==0.15.0`
- `bitsandbytes>=0.48.0`
- `safetensors==0.8.0rc1` explicitly, because `diffusers==0.38.0`
  depends on prerelease `safetensors>=0.8.0rc0` and uv does not enable
  transitive prereleases by default.
