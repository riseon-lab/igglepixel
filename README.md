...
| Image-to-video | Wan 2.2 I2V, LTX-2.3 I2V | Wan has 14B Lightning 8-step, 14B, and 5B variants. LTX-2.3 defaults to the pre-quantized FP8 distilled image-conditioned path. |
| Text / image to video | Wan 2.2 T2V, LTX-2.3 T2V, HunyuanVideo | LTX-2.3 T2V shares the FP8 distilled runtime without a source frame; HunyuanVideo has NF4 (24 GB) and BF16 (80 GB) paths. |
